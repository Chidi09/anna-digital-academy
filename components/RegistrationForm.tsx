    ...
    return (
        <section id="register" className="py-24 px-6 bg-ada-black">
            <div className="w-full max-w-3xl mx-auto bg-ada-teal/20 backdrop-blur-md border border-ada-teal/30 rounded-2xl p-8 md:p-12 shadow-2xl">
                <h2 className="text-3xl font-serif text-ada-gold mb-2">Secure Your Spot</h2>
                <p className="text-gray-300 mb-8 font-sans">Cohort 1 Founding Price: <span className="text-white font-bold text-lg">{PRICE}</span></p>

                <form onSubmit={handleSubmit} className="space-y-6">
                    {/* Personal Details */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <label className="text-sm text-ada-gold/80 font-sans">Full Name</label>
                            <input
                                type="text"
                                name="fullName"
                        ...
                        <div className="space-y-2">
                            <label className="text-sm text-ada-gold/80 font-sans">Email Address</label>
                            <input
                                type="email"
                                name="email"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <label className="text-sm text-ada-gold/80 font-sans">WhatsApp Number</label>
                            <input
                                type="tel"
                                name="whatsapp"
                        ...
                        <div className="space-y-2">
                            <label className="text-sm text-ada-gold/80 font-sans">Gender</label>
                            <select
                                name="gender"
                                ...
                                className="w-full bg-black/40 border border-ada-teal/50 rounded-lg p-4 text-white focus:border-ada-gold focus:outline-none focus:ring-1 focus:ring-ada-gold transition-all font-sans"
                            >
                                <option value="" className="bg-ada-black">Select Gender</option>
                                <option value="Male" className="bg-ada-black">Male</option>
                                <option value="Female" className="bg-ada-black">Female</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        <label className="text-sm text-ada-gold/80 font-sans">Admission Officer Code (Optional)</label>
                        <input
                            type="text"
                            name="referralCode"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        ...
                        >
                            <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${paymentMethod === 'online' ? 'border-ada-gold' : 'border-gray-500'}`}>
                                {paymentMethod === 'online' && <div className="w-2.5 h-2.5 bg-ada-gold rounded-full" />}
                            </div>
                            <div>
                                <p className="text-white font-medium font-sans">Pay with Card / Online</p>
                                <p className="text-xs text-gray-400 font-sans">Instant confirmation via Paystack/Flutterwave</p>
                            </div>
                        </div>
                        ...
                        >
                            <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${paymentMethod === 'transfer' ? 'border-ada-gold' : 'border-gray-500'}`}>
                                {paymentMethod === 'transfer' && <div className="w-2.5 h-2.5 bg-ada-gold rounded-full" />}
                            </div>
                            <div>
                                <p className="text-white font-medium font-sans">Bank Transfer</p>
                                <p className="text-xs text-gray-400 font-sans">Manual review (24-48hrs)</p>
                            </div>
                        </div>
                    </div>
                        ...
                        {paymentMethod === "online" ? (
                            ...
                            >
                                <div className="bg-green-900/20 border border-green-500/30 p-4 rounded-lg flex items-start gap-3">
                                    ...
                                    <p className="text-sm text-green-200 font-sans">
                                        Best Option: Access details are sent automatically within 24 hours of successful online payment.
                                    </p>
                                </div>
                                <button
                                    type="submit"
                            ...
                            >
                                <div className="bg-black/40 p-6 rounded-lg border border-white/10">
                                    <p className="text-sm text-gray-400 mb-2 font-sans">Transfer exactly {PRICE} to:</p>
                                    <p className="text-xl text-ada-gold font-mono font-bold">0123456789</p>
                                    <p className="text-white font-sans">GTBank</p>
                                    <p className="text-white font-sans">Anna Digital Academy</p>
                                </div>

                                <div className="space-y-2">
                                    <label className="text-sm text-ada-gold/80 font-sans">Upload Proof of Payment (Screenshot/PDF)</label>
                                    <input
                                        type="file"
                                        id="proofUpload"
                                    ...
                                    />
                                    <label htmlFor="proofUpload" className="border-2 border-dashed border-ada-teal/50 rounded-lg p-8 text-center cursor-pointer hover:border-ada-gold transition-colors block">
                                ...
                                <div className="bg-yellow-900/20 border border-yellow-500/30 p-4 rounded-lg flex items-start gap-3">
                                    ...
                                    <p className="text-sm text-yellow-200 font-sans">
                                        Note: Access will be granted only after payment is verified within 24-48 hours.
                                    </p>
                                </div>
